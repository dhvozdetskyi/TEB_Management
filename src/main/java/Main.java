...
import entity.User;
import fasade.UserRegisterLoginFasadeImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        UserRegisterLoginFasade userFasade = UserRegisterLoginFasadeImpl.getInstance();
        ...
        while (appOn) {
            ...
            switch (read) {
                case 1:
                    ...
                    if (userFasade.loginUser(loginLog, passwordLog)) {
                        loggedOn = true;
                ...
                case 2:
                    ...
                    if (userFasade.registerUser(user)) {
